...
Sub 宏()
    ROW = Sheets("控制面板").Range("C7")
    COLUMN = Sheets("控制面板").Range("C8")
    HEAD = Sheets("控制面板").Range("C3")
    DATA = Sheets("控制面板").Range("C9")
    TIMES = Sheets("控制面板").Range("C15")
    If ROW = 0 Or COLUMN = 0 Or HEAD = 0 Or DATA = 0 Then
    Call 表格检测
    ROW = Sheets("控制面板").Range("C7")
    COLUMN = Sheets("控制面板").Range("C8")
    HEAD = Sheets("控制面板").Range("C3")
